...
- (void)touchesBegan:(NSSet<UITouch *> *)touches withEvent:(UIEvent *)event{
    ...
    UIAlertController *alertVC = [UIAlertController alertControllerWithTitle:@"提示" message:@"测试数据啦啦啦啦啦啦啦啦啦啦啦啦啦啦啦啦啦啦啦啦啦啦啦啦啦" preferredStyle:UIAlertControllerStyleAlert];
